      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-6 text-slate-400 text-lg md:text-xl leading-relaxed text-justify">
            ...
            <p>
              With a strong foundation in <span className="text-white">Machine Learning, Blockchain, and Full-Stack Development</span>, I enjoy the challenge of bridging the gap between high-level application logic and low-level system optimization. I've worked on projects ranging from decentralized supply chain trackers to real-time healthcare monitoring systems.
            </p>
            <p>
